...
while($result=mysqli_fetch_assoc($data2))
{
    ...
    <td><a style='color:white' href ='pa_upd.php?rn=$result[Student_Id]&fn=$result[Father_Name]&cn=$result[Mother_Name]&an=$result[Mother_Tongue]&pn=$result[Occupation]'>Edit/Update </td>
    </tr>   
    "; 
}
