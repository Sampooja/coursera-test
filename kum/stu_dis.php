...
if($total!=0)
{
    while($result=mysqli_fetch_assoc($data))
    {
        ...
        <td><a style='color:white' href ='stu_upd.php?rn=$result[Student_Id] & fn=$result[Name]&cn=$result[Class]&an=$result[Academic_Year]&pn=$result[Phone_Number]&
        dn=$result[Date_Of_Birth]&gn=$result[Gender]&ad=$result[Address]'>Edit/Update</td>

        <td><a style='color:white' href ='delete.php?rn=$result[Student_Id]' onclick='return checkdelete()'>Delete</td>
        ";
    }
