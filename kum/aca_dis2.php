...
if($total!=0)
{
    while($result=mysqli_fetch_assoc($data))
    {
      ...
      $result['Sql_ac']=number_format(($result['Sql_A']/$result['Sql_C'])*100,2);
        ...
        <td id=link align='center'><a style='color:white' href ='aca_upd2.php?a=$result[Student_Id]&b=$result[Java_Marks]&c=$result[Java_A]&d=$result[Java_C]&e=$result[Python_Marks]
